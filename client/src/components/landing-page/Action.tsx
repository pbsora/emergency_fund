...
const Action = () => {
  return (
    <div className="relative bg-slate-50 lg:py-20 lg:px-36">
      ...
      <div className="flex flex-col lg:flex-row mx-10 px-3 rounded-lg lg:px-8 py-5 gap-7 items-center bg-slate-50 z-20 relative">
        ...
        <Button className="w-2/4 lg:w-2/12 bg-yellow-400 hover:bg-yellow-600 text-white font-semibold self-start">
          <Link href={"/register"}>
            Start your journey!
          </Link>
        </Button>
